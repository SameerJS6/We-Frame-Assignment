...
export default function Home() {
  return (
    <div className="px-4 sm:px-6 lg:px-8 xl:px-12 pt-24 sm:pt-28 lg:pt-32">
      <div className="mb-7">
      ...
      <div className="grid gap-4 lg:gap-6">
        <div className="flex items-center justify-between">
          ...
          <button className="text-body-md font-medium h-10 px-3 transition-all duration-250 ease-in-out bg-transparent hover:bg-[#eee5ff] rounded-xl text-[#9058FF]">
            See all
          </button>
        </div>
      ...
      <div className="grid gap-4 lg:gap-6">
        ...
        <div className="article-wrapper stories-wrapper snaps-inline mb-9 rounded-3xl">
          {StoriesData.map((data, index) => (
            <StoriesCard key={index} id={index} {...data} />
          ))}
        </div>
      </div>
