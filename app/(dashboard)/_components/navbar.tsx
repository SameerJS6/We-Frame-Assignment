...
export default function Navbar({ setIsSidebarOpen }: NavbarProps) {
  ...
  return (
    <nav className="absolute left-0 lg:left-[280px] top-0 flex w-full lg:w-[calc(100%-280px)] items-center justify-between px-4 sm:px-6 lg:px-8 py-3 bg-white lg:rounded-es-3xl lg:rounded-ee-3xl">
      ...
      >
        <span className="material-symbols-rounded text-[#030229] leading-normal text-xl">
          arrow_back
        </span>
      </button>
      ...
      >
        ...
        <input
          type="text"
          placeholder="Search"
          className="w-full h-full pr-8 pl-9 xl:px-12 text-[#030229] rounded-xl border-none outline-none focus-visible:ring-1 bg-[#FAFAFA] placeholder:text-label-sm placeholder:text-[#CECECE]"
        />
      </div>
